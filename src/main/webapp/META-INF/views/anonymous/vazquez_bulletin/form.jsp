...
<acme:form>
	...
	<acme:form-textarea code="anonymous.vazquezBulletin.form.label.punctuation" path="punctuation"/>
	
	<acme:form-submit code="anonymous.vazquezBulletin.form.button.create" action="/anonymous/vazquez_bulletin/create"/>
  	<acme:form-return code="anonymous.vazquezBulletin.form.button.return"/>
</acme:form>
